...
static grn_inline void
_grn_obj_remove_log_spec_remove(grn_ctx *ctx,
                                grn_obj *db,
                                grn_id id,
                                uint8_t type)
{
...
static grn_rc
_grn_obj_remove_pat(grn_ctx *ctx,
                    grn_obj *obj,
                    grn_obj *db,
                    grn_id id,
                    const char *path,
                    grn_bool dependent)
{
  ...
  if (path) {
    ...
    _grn_obj_remove_log_spec_remove(ctx, db, id, type);
...
static grn_rc
_grn_obj_remove_dat(grn_ctx *ctx,
                    grn_obj *obj,
                    grn_obj *db,
                    grn_id id,
                    const char *path,
...
static grn_rc
_grn_obj_remove_hash(grn_ctx *ctx,
                     grn_obj *obj,
                     grn_obj *db,
                     grn_id id,
                     const char *path,
...
static grn_rc
_grn_obj_remove_array(grn_ctx *ctx,
                      grn_obj *obj,
                      grn_obj *db,
                      grn_id id,
                      const char *path,
